...
class test_10g(object):
  def __init__(self, name, bitstream=None, Fe=None, feed='BF'):
    ...
    self.fpga.write_int('TGbE_dst_ip6'   , 0xc0a805b9, blindwrite=True)   # 192.168.5.186
    self.fpga.write_int('TGbE_dst_ip7'   , 0xc0a805ba, blindwrite=True)   # 192.168.5.187
    self.fpga.write_int('TGbE_dst_ip5'   , 0xc0a805bb, blindwrite=True)   # 192.168.5.185
